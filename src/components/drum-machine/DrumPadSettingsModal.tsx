...
export default function DrumPadSettingsModal({ visible, onClose }: Props) {
  ...
  const { 
    velocityZonesEnabled, setVelocityZonesEnabled,
    padAssignments, setPadCount
  } = useDrumMachineStore();
      ...
      <View style={styles.overlay}>
        <View style={[styles.container, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          <View style={styles.header}>
            <Text style={[styles.title, { color: colors.text }]}>Pad Settings</Text>
          ...
          <View style={styles.settingRow}>
            <View>
              <Text style={[styles.settingLabel, { color: colors.text }]}>Velocity Zones</Text>
              <Text style={[styles.settingDesc, { color: colors.textSecondary }]}>Tap top of pad for louder sound</Text>
            </View>
            <Switch 
          ...
          <View style={styles.settingRow}>
            <View>
              <Text style={[styles.settingLabel, { color: colors.text }]}>Number of Pads</Text>
              <Text style={[styles.settingDesc, { color: colors.textSecondary }]}>Total pads to display in the grid</Text>
            </View>
            <View style={styles.counter}>
              ...
              <Text style={[styles.counterText, { color: colors.text }]}>{padCount}</Text>
              <Pressable 
                style={[styles.counterBtn, { backgroundColor: colors.background, borderColor: colors.border }]}
                onPress={() => {
                  HapticService.light();
